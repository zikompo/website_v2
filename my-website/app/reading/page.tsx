    ...
    const bookReviews = [
        ...
        },
        {
            ...
            review: [
                ...
                "This was my first time reading a fiction book in a long time, and I think I will get back into reading more after this.",
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2 text-xl pl-4">
                                    <motion.p variants={listItemVariants}
                                        ...
                                        <span
                                            className="ml-1"> by Daniel Keyes</span>
                                    </motion.p>
                                </div>
                            </div>
                        </motion.div>
              ...
              <span>
                Books I&apos;ve read this year ({booksReadThisYear.length})
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    <p className="italic">
                                        ...
                                        Not all books will receive detailed
                                        reviews as I created
                                        this website recently and read some of
                                        these books a while
                                        ago. I may not be able to provide
                                        reviews that accurately
                                        reflect what I actually thought of the
                                        book at the time of
                                        reading.
                                    </p>
                                </motion.div>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-3xl font-bold font-grotesk">Book
                            Reviews</h2>
